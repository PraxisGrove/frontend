...
const navItems = [
  { name: '首页', link: '/' },
  { name: '样式演示', link: '/styles-demo' },
  { name: '动画演示', link: '/animations-demo' },
  { name: 'Aceternity', link: '/aceternity-demo' },
];
          ...
          <section className="space-y-8">
            <EnhancedCard variant="glass" className="text-center">
              ...
              <div className="mx-auto grid max-w-2xl gap-4 text-left md:grid-cols-2">
                <div>
                  <h4 className="font-medium text-primary">📱 移动端优化</h4>
                  <p className="text-sm text-muted-foreground">
                    针对移动设备优化的样式和交互
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-primary">💻 桌面端增强</h4>
                  <p className="text-sm text-muted-foreground">
                    桌面端的增强视觉效果和动画
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-primary">🌙 主题适配</h4>
                  <p className="text-sm text-muted-foreground">
                    深色和浅色主题的完美适配
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-primary">♿ 无障碍支持</h4>
                  <p className="text-sm text-muted-foreground">
                    支持高对比度和减少动画模式
                  </p>
                </div>
