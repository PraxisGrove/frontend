          ...
          <section className="space-y-8">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              <div className="space-y-2 text-center">
                ...
                <p className="text-sm text-muted-foreground">通知图标</p>
              </div>
              ...
              <div className="space-y-2 text-center">
                ...
                <p className="text-sm text-muted-foreground">邮件图标</p>
              </div>
              ...
              <div className="space-y-2 text-center">
                ...
                <p className="text-sm text-muted-foreground">消息图标</p>
              </div>
              ...
              <div className="space-y-2 text-center">
                ...
                <p className="text-sm text-muted-foreground">超过最大值</p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-8">
            <Card className="bg-muted/50 p-8 text-center">
              ...
              <div className="mx-auto grid max-w-4xl gap-4 text-left md:grid-cols-2 lg:grid-cols-3">
                <div>
                  <h4 className="font-medium text-primary">🎨 多种类型</h4>
                  <p className="text-sm text-muted-foreground">
                    支持成功、错误、警告、信息等多种消息类型
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-primary">⚡ 现代化</h4>
                  <p className="text-sm text-muted-foreground">
                ...
                <div>
                  <h4 className="font-medium text-primary">🔔 通知中心</h4>
                  <p className="text-sm text-muted-foreground">
                    完整的通知管理系统
                  </p>
                </div>
