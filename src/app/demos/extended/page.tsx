        ...
        <EnhancedContainer className="space-y-24 py-16">
          ...
          <section className="space-y-8 text-center">
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <button className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg px-8 py-3 text-lg font-medium transition-colors">
                查看源码
              </button>
              <button className="border-border text-foreground hover:bg-accent rounded-lg border px-8 py-3 text-lg font-medium transition-colors">
                阅读文档
              </button>
            </div>
          </section>
