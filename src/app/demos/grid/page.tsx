                    ...
                    <Card className="h-40">
                      <CardContent className="p-4">
                        ...
                        <div className="mt-4 flex gap-1">
                          <div className="bg-primary h-2 w-2 rounded-full opacity-20 sm:opacity-40 md:opacity-60 lg:opacity-80" />
                          <div className="bg-primary h-2 w-2 rounded-full opacity-0 sm:opacity-20 md:opacity-40 lg:opacity-60" />
                          <div className="bg-primary h-2 w-2 rounded-full opacity-0 md:opacity-20 lg:opacity-40" />
                          <div className="bg-primary h-2 w-2 rounded-full opacity-0 lg:opacity-20" />
                        </div>
                      </CardContent>
                    </Card>
                  </GridItem>
