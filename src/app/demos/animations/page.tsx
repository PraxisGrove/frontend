            ...
            >
              <AnimatedItem animation="fadeIn">
                <Card className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">fadeIn</p>
                </Card>
              </AnimatedItem>
              ...
              <AnimatedItem animation="slideUp">
                <Card className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">slideUp</p>
                </Card>
              </AnimatedItem>
              ...
              <AnimatedItem animation="scaleIn">
                <Card className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">scaleIn</p>
                </Card>
              </AnimatedItem>
              ...
              <AnimatedItem animation="bounceIn">
                <Card className="p-6 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">bounceIn</p>
                </Card>
              </AnimatedItem>
            </AnimatedContainer>
          </section>
            ...
            <AnimatedContainer animation="fadeIn" delay={0.5}>
              <Card className="bg-muted/50 p-8 text-center">
                ...
                <div className="mx-auto grid max-w-2xl gap-4 text-left md:grid-cols-2">
                  <div>
                    <h4 className="text-primary font-medium">🚀 GPU 加速</h4>
                    <p className="text-muted-foreground text-sm">
                      使用 transform 和 opacity 属性确保 GPU 加速
                    </p>
                  </div>
                  <div>
                    <h4 className="text-primary font-medium">⚡ 智能优化</h4>
                    <p className="text-muted-foreground text-sm">
                      自动检测设备性能，调整动画复杂度
                    </p>
                  </div>
                  <div>
                    <h4 className="text-primary font-medium">🎯 按需加载</h4>
                    <p className="text-muted-foreground text-sm">
                      组件化设计，只加载需要的动画效果
                    </p>
                  </div>
                  <div>
                    <h4 className="text-primary font-medium">🔧 可配置</h4>
                    <p className="text-muted-foreground text-sm">
                      支持自定义动画参数和性能配置
                    </p>
                  </div>
